...
var subscriptionID = flag.String("subID", simulation.RequestSubscriberID2, "the subscription ID for the topic")
var dstFilter = flag.String("dst", "subscriber-2", "Listen for this destination")
