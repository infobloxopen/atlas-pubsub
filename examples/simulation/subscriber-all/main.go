...
var topic = flag.String("topic", simulation.RequestTopicTopicName, "the topic to subscribe to")
var subscriptionID = flag.String("subID", simulation.RequestSubscriberIDAll, "the subscription ID for the topic")
var dstFilter = flag.String("dst", "", "Listen for all destinations")
